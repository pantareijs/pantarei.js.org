...
! function() {
    ...
    n.shadow = n.shadow || n.shadowdom || n.polyfill, "native" === n.shadow ? n.shadow = !1 : n.shadow = n.shadow || !HTMLElement.prototype.createShadowRoot, n.register && (window.CustomElements = window.CustomElements || {
        flags: {}
        ...
        n.prototype = {
            calcEditDistances: function(e, t, n, r, o, i) {
                ...
                for (var l = 1; l < a; l++)
                    for (var u = 1; u < s; u++)
                        if (this.equals(e[t + u - 1], r[o + l - 1])) c[l][u] = c[l - 1][u - 1];
                        else {
                            var d = c[l - 1][u] + 1,
                                p = c[l][u - 1] + 1;
                            c[l][u] = d < p ? d : p
        ...
        var r, o = window.MutationObserver,
            i = [],
            a = !1;
        if (o) {
            var s = 1,
        ...
        function g(e, t, n, r, o) {
            ...
            for (var m = 0, w = i.length; m < w; m++) {
                var v = i[m];
                if (v.removed) f = !0;
                else if (!(v.type !== h || !v.capture && n === oe || v.capture && n === ae)) try {
        ...
        function D(e, t) {
            for (var n = B(e); n; n = n.parentNode)
                if (j(V(n), t)) return !0;
            return !1
        }
        ...
        var le = _("UIEvent", y),
            ue = _("CustomEvent", y),
            de = {get relatedTarget() {
                    var e = Z.get(this);
                    return void 0 !== e ? e : V(B(this).relatedTarget)
                }
            },
            pe = W({
                initMouseEvent: S("initMouseEvent", 14)
            }, de),
            he = W({
                initFocusEvent: S("initFocusEvent", 5)
            }, de),
        ...
        if (!ve) {
            ...
            ge("Event", {
                ...
                button: 0,
                relatedTarget: null
            }, "UIEvent"), ge("FocusEvent", {
                relatedTarget: null
            }, "UIEvent")
        }
        var be = window.BeforeUnloadEvent;
        M.prototype = Object.create(y.prototype), W(M.prototype, {get returnValue() {
        ...
        if (p) {
            ...
            }, i.prototype = Object.create(a.prototype), s(i.prototype, {get touches() {
        ...
        function v(e) {
            if (e.invalidateShadowRenderer()) {
                ...
                for (var n, i = P(e), a = i.firstChild; a;) n = a.nextSibling, X.call(i, a), a = n
        }
        ...
        function y(e, t, n) {
            ...
            if (r = A(n ? q.call(n, I(e), !1) : B.call(I(e), !1)), t) {
                ...
                if (e instanceof F.HTMLTemplateElement)
                    for (var i = r.content, o = e.content.firstChild; o; o = o.nextSibling) i.appendChild(y(o, !0, n))
            }
            return r
        }
        ...
        _.prototype = Object.create(S.prototype), D(_.prototype, {
            ...
            insertBefore: function(e, n) {
                ...
                var o, s = n ? n.previousSibling : this.lastChild,
                    c = !this.invalidateShadowRenderer() && !g(e);
                if (o = c ? a(e) : i(e, this, s, n), c) h(this, e), w(this), $.call(I(this), P(e), r);
                else {
        ...
        t.prototype = Object.create(r.prototype), i(t.prototype, {get nodeValue() {
                return this.data
            },
            set nodeValue(e) {
                this.data = e
        ...
        var o = e.ChildNodeInterface,
            ...
            f = e.wrappers,
            m = window.Element,
            w = ["matches", "mozMatchesSelector", "msMatchesSelector", "webkitMatchesSelector"].filter(function(e) {
        ...
        var m = e.wrappers.Element,
            ...
            L = /[&\u00A0"]/g,
            N = /[&\u00A0<>]/g,
            C = o(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]),
            j = o(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]),
            D = "http://www.w3.org/1999/xhtml",
            H = /MSIE/.test(navigator.userAgent),
            x = window.HTMLElement,
            R = window.HTMLTemplateElement;
        l.prototype = Object.create(m.prototype), g(l.prototype, {get innerHTML() {
                return s(this)
            },
            set innerHTML(e) {
        ...
        t.prototype = Object.create(n.prototype), r(t.prototype, {get elements() {
        ...
        n.prototype = Object.create(o.prototype), i(n.prototype, {get text() {
        ...
        t.prototype = Object.create(n.prototype), r(t.prototype, {get caption() {
        ...
        t.prototype = Object.create(n.prototype), r(t.prototype, {get cells() {
        ...
        t.prototype = Object.create(n.prototype), s(t.prototype, {get ownerSVGElement() {
        ...
        var n = e.mixin,
            ...
            p = d.constructor;
        t.prototype = Object.create(d), "instanceRoot" in l && n(t.prototype, {get instanceRoot() {
        ...
        s && (t.prototype = Object.create(n.prototype), r(t.prototype, {get correspondingElement() {
        ...
        o.prototype = {get startContainer() {
        ...
        function n(n, o, i) {
            var a = x(n),
                s = x(o),
                c = i ? x(i) : null;
            if (r(o), t(o), i) n.firstChild === i && (n.firstChild_ = i), i.previousSibling_ = i.previousSibling;
            else {
        ...
        var T, M = e.wrappers.Element,
            ...
            k = new WeakMap,
            A = new WeakMap,
            W = D(window, ["requestAnimationFrame", "mozRequestAnimationFrame", "webkitRequestAnimationFrame", "setTimeout"]),
            F = [],
            U = new I;
            ...
            poolDistribution: function(e, t) {
                if (!(e instanceof L))
                    if (e instanceof O) {
                        ...
                        for (var i = e.firstChild; i; i = i.nextSibling) this.poolDistribution(i, t)
            },
        ...
        function t(t) {
            if (window[t]) {
                ...
                c.prototype = Object.create(n.prototype), o(c.prototype, {get form() {
        ...
        E([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), E([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], _), E([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "createTreeWalker", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), S(t.prototype, l), S(t.prototype, d), S(t.prototype, f), S(t.prototype, p), S(t.prototype, {get implementation() {
                var e = H.get(this);
        ...
        var u = {
            ...
            O = g + "-no-combinator",
            L = new RegExp(g, "gim"),
            N = (new RegExp(b, "gim"), [/>>>/g, /::shadow/g, /::content/g, /\/deep\//g, /\/shadow\//g, /\/shadow-deep\//g, /\^\^/g, /\^(?!=)/g]),
            C = document.createElement("iframe");
        C.style.display = "none";
        var j, D = navigator.userAgent.match("Chrome"),
            H = "shim-shadowdom",
            ...
            e: for (;
                ...
                switch (l) {
                    ...
                    case "relative":
                        ...
                        else if ("?" == y) this._host = s._host, this._port = s._port, this._path = s._path.slice(), this._query = "?", this._username = s._username, this._password = s._password, l = "query";
                        else {
                            if ("#" != y) {
                                var E = e[u + 1],
                                    _ = e[u + 2];
    ...
    function(e) {
        ...
        function i(e, t) {
            ...
            var s = t.querySelectorAll("link[rel=import]"),
                ...
                d = [];
            if (l)
                for (var p, h = 0; h < l && (p = s[h]); h++) a(p) ? (u.push(this), c++, n()) : (p.addEventListener("load", r), p.addEventListener("error", i));
            else n()
        }
        ...
        d && (new MutationObserver(function(e) {
            ...
            if ("loading" === document.readyState)
                for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, r = t.length; n < r && (e = t[n]); n++) l(e)
        }()), t(function(e) {
            ...
            p = {
                ...
                nextToParseInDoc: function(e, n) {
                    if (e && this._mayParse.indexOf(e) < 0) {
                        ...
                        for (var r, o = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = o.length; i < a && (r = o[i]); i++)
